    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comuna', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='gestion.comuna')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
            fields=[
                ...
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('fecha_actualizacion', models.DateTimeField(auto_now=True)),
                ('asamblea', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='gestion.asamblea')),
                ('comuna', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='gestion.comuna')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('representante', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
